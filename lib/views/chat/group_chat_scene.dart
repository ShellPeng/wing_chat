...
import 'package:wing_chat/provider/group_chat_provider.dart';
import 'package:wing_chat/tools/expanded_viewport.dart';
final ThemeColor = Color.fromRGBO(237, 237, 237, 1.0);

class GroupChatScene extends StatelessWidget {
  final JMGroupInfo groupInfo;

  const GroupChatScene({Key key, this.groupInfo}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        ...
        child: Consumer<GroupChatProvider>(builder: (_, provider, widget) {
          return Scaffold(
            appBar: AppBar(title: Text('${groupInfo.name}')),
...
class GroupChatList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<GroupChatProvider>(builder: (_, provider, widget) {
